        ...
        return [
            Column::make('Action')
                ->format(function ($value, $column, $row) {
                    return view('admin.simulation.column.action')->with('simulation', $row);
                }),
            Column::make('title')
                ->searchable()
            ...
            Column::make('Status')
                ->format(function ($value, $column, $row) {
                    return view('admin.simulation.column.status')
                        ->with([
            ...
            Column::make('mulai', 'start_time')
                ->format(function ($value, $column, $row) {
                    return Carbon::create($row->start_time)->format('d M Y h:i A');
                }),
            Column::make('berakhir', 'end_time')
                ->format(function ($value, $column, $row) {
                    return Carbon::create($row->end_time)->format('d M Y h:i A');
                }),
        ];
    }
