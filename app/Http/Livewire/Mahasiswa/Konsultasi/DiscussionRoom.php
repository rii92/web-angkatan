...
class DiscussionRoom extends Component
{
    ...
    {
        if ($this->konsul->status != AppKonsul::STATUS_DONE) return $this->emit('error', "Something wrong, you can't publish this konsultasi");
    ...
    {
        if ($this->konsul->status != AppKonsul::STATUS_DONE) return $this->emit('error', "Something wrong, you can't unpublish this konsultasi");
