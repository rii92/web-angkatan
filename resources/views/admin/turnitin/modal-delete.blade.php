<form wire:submit.prevent="handleForm">
    <x-modal.header title="Delete Turnitin Submission" bordered />
    <x-modal.body>
        Apakah anda yakin menghapus pengajuan turnitin ini? Harap menggunakan fitur ini jika memang sangat diperlukan.
