                        ...
                        <span>
                            ...
                            @else
                                <button wire:click="previousPage('{{ $paginator->getPageName() }}')"
                                    ...
                                    rel="prev"
                                    class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-l-md leading-5 hover:text-gray-400 focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150 page-link-scroll-to-top"
                                    ...
                                    <span
                                        ...
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span
                                                    class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-blue-500 bg-gray-100 border border-blue-300 z-10 cursor-default leading-5">{{ $page }}</span>
                                            </span>
                                        @else
                                            <button
