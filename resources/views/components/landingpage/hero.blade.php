...
<div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000" class="hero pb-80 pt-36">
    <h1>
    ...
    <p
        class="font-archivo-narrow font-semibold text-main text-center md:text-xl xl:w-7/12 lg:w-8/12 md:w-10/12 max-w-7xl px-5 mx-auto">
        {{ $description }}
    </p>
</div>
